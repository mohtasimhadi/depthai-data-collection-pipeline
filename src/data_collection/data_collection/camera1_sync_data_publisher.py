...
class Camera1EncoderPublisher(Node):
    def __init__(self):
        super().__init__('camera1_encoder_publisher')

        self.publisher_rgb = self.create_publisher(String, 'camera1/rgb_encoded', 10)
        self.publisher_left = self.create_publisher(String, 'camera1/left_encoded', 10)
        self.publisher_right = self.create_publisher(String, 'camera1/right_encoded', 10)
